...
void glDrawGrid(const float xNum,const float zNum,const float size)
{
...
void glDrawTexture(const float width, const float height, float left, float right, float top, float bottom, const int tex)
{
